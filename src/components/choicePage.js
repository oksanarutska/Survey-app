function ChoicePage() {
    ...
    buttons.forEach(function (e) {
        e.addEventListener('click', function (b) {
            ...
            overlay.show('#fc8950',b.currentTarget.dataset.number+'%' ,'людей обращают внимание на ' +  b.currentTarget.dataset.value )
        })
    });
    ...
    document.querySelector('.container-main-choice.container-main')
        .style
