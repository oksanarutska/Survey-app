function ChoiceSexPage() {
    ...
    buttons.forEach(function (e){
        e.addEventListener('click', function (b) {
            ...
            overlay.show('#fcc150',b.currentTarget.dataset.number+'%' ,'пользователей - вариант ' +  b.currentTarget.dataset.sex )
    ...
    document.querySelector('.container-main-choice-sex.container-main')
        .style
